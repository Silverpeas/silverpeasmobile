...
public class WorkflowItem extends Composite implements ClickHandler {

  private WorkflowInstanceDTO data;
  ...
  interface FavoriteItemUiBinder extends UiBinder<Widget, WorkflowItem> {}
  ...
  public void setData(WorkflowInstanceDTO data) {
    this.data = data;
    content.setHTML("<p>" + data.getId() + "</p><h2><a href='#'>" + data.getTitle() + "</a></h2>");
