...
public class SuperDevModeGenerator extends Generator{
	...
	public String generate(TreeLogger logger, GeneratorContext context, String typeName) throws UnableToCompleteException {
		...
		if("on".equals(mgwtSuperDevmodePropertyValue)){
			...
			return "com.silverpeas.mobile.client.common.gwt.impl.SuperDevModeOffImpl";
		}
	...
	private String buildOnImplementation(TreeLogger logger, GeneratorContext context, JClassType classType, String typeName, ConfigurationProperty superDevModeServer) {
		...
		if(superDevModeServer.getValues().get(0) == null){
			//use default impl!
			return "com.silverpeas.mobile.client.common.gwt.impl.SuperDevModeHelperOnDefaultImpl";
		}
		...
		composer.setSuperclass("com.silverpeas.mobile.client.common.gwt.impl.SuperDevModeHelperOnImpl");
		composer.addImport("com.silverpeas.mobile.client.common.gwt.impl.SuperDevModeHelperOnImpl");
