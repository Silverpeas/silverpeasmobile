...
import org.silverpeas.mobile.shared.exceptions.AlmanachException;
import org.silverpeas.mobile.shared.exceptions.AuthenticationException;
import org.silverpeas.mobile.shared.exceptions.HyperLinkException;

import java.util.List;

public interface ServiceHyperLinkAsync {
  void getUrl(String instanceId, final AsyncCallback<String> async);
}
