...
<c:set var="zeBackLabel" value="${(empty backLabel) ? 'Share Document' : backLabel}"/>
...
<div  data-role="page" >
	...
	<div  data-role="content">
		...
		<strong>Please copy the link bellow and paste it in a mail or a sms</strong>
		
		<div data-role="fieldcontain">
		    <label for="url">URL:</label>
		    <input type="text" name="url" value="${urlAttachment}"  />
		</div>	
		
		<i>Note: The link is active for next 24 hours and for 1 access</i>
