...
//  SilverpeasMobile
//
//  Created by Laurent LOISEAU on 22/03/12.
...
{    
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
		...
		NSLog(@"SilverpeasMobile launchOptions = %@", url);
    }    
    ...
    NSDictionary *appDefaults = [NSDictionary dictionaryWithObject:@"http://my.silverpeas.com" forKey:@"URLServeur"];
