...
public class ServiceDocumentsImpl extends AbstractAuthenticateService implements ServiceDocuments {
   ...
   */
  @Override
  public List<TopicDTO> getTopics(String instanceId, String rootTopicId) throws DocumentsException,
    ...
    try {
      ...
      for (NodeDetail nodeDetail : nodes) {
        ...
        if (rootTopicId.equals(nodeDetail.getFatherPK().getId())) {
          ...
          int childrenNumber =
              getNodeBm().getChildrenNumber(
                  new NodePK(String.valueOf(nodeDetail.getId()), instanceId));
   ...
   */
  @Override
  public List<PublicationDTO> getPublications(String instanceId, String topicId)
      throws DocumentsException, AuthenticationException {
    checkUserInSession();
    ...
    try {
      ...
      List<PublicationDetail> publications =
          (List<PublicationDetail>) getPubBm().getDetailsByFatherIdsAndStatus(nodeIds, pubPK,
              "pubname", status);
  ...
  @Override
  public PublicationDTO getPublication(String pubId) throws DocumentsException,
      AuthenticationException {
    checkUserInSession();
    try {
