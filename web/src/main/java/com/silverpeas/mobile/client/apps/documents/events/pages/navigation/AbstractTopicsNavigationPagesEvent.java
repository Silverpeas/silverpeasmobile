...
public abstract class AbstractTopicsNavigationPagesEvent extends
    GwtEvent<TopicsNavigationPagesEventHandler> {

  public static Type<TopicsNavigationPagesEventHandler> TYPE =
      new Type<TopicsNavigationPagesEventHandler>();
