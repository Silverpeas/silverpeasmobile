...
public abstract class AbstractPublicationPagesEvent extends
    GwtEvent<PublicationNavigationPagesEventHandler> {

  public static Type<PublicationNavigationPagesEventHandler> TYPE =
      new Type<PublicationNavigationPagesEventHandler>();
