...
public abstract class AbstractPictureViewerPageEvent extends
    GwtEvent<PicturesViewerPageEventHandler> {

  public static Type<PicturesViewerPageEventHandler> TYPE =
      new Type<PicturesViewerPageEventHandler>();
