...
import com.silverpeas.mobile.client.apps.media.events.pages.local.AbstractLocalPicturesPageEvent;
import com.silverpeas.mobile.client.apps.media.events.pages.local.DeletedLocalPictureEvent;
import com.silverpeas.mobile.client.apps.media.events.pages.local.LocalPicturesPageEventHandler;
