...
public abstract class AbstractNavigationControllerEvent extends
    GwtEvent<NavigationControllerEventHandler> {

  public static Type<NavigationControllerEventHandler> TYPE =
      new Type<NavigationControllerEventHandler>();
