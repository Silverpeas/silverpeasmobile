...
public class AgendaPage extends Page {
  ...
  public AgendaPage() {
    ...
    /*
     * ServicesLocator.serviceAgenda.viewAgenda(new AsyncCallback<Void>() { public void
     * onFailure(Throwable reason) { Window.alert("Loading error"); } public void onSuccess(Void
     * result) { } });
     */
  }
}
