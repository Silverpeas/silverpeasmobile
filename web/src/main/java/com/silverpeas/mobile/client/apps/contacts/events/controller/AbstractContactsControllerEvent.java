...
public abstract class AbstractContactsControllerEvent extends
    GwtEvent<ContactsControllerEventHandler> {

  public static Type<ContactsControllerEventHandler> TYPE =
      new Type<ContactsControllerEventHandler>();
