...
public abstract class AbstractContactsDetailPagesEvent extends
    GwtEvent<ContactDetailPagesEventHandler> {

  public static Type<ContactDetailPagesEventHandler> TYPE =
      new Type<ContactDetailPagesEventHandler>();
