...
public abstract class AbstractGalleryControllerEvent extends
    GwtEvent<GalleryControllerEventHandler> {

  public static Type<GalleryControllerEventHandler> TYPE =
      new Type<GalleryControllerEventHandler>();
