...
import com.silverpeas.mobile.client.apps.media.events.pages.AbstractGalleryPagesEvent;
import com.silverpeas.mobile.client.apps.media.events.pages.GalleryEndUploadEvent;
import com.silverpeas.mobile.client.apps.media.events.pages.GalleryLoadedSettingsEvent;
import com.silverpeas.mobile.client.apps.media.events.pages.GalleryLocalPicturesLoadedEvent;
import com.silverpeas.mobile.client.apps.media.events.pages.GalleryNewInstanceLoadedEvent;
import com.silverpeas.mobile.client.apps.media.events.pages.GalleryPagesEventHandler;
