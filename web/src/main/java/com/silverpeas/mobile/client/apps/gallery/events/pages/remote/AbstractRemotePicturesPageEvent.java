...
public abstract class AbstractRemotePicturesPageEvent extends
    GwtEvent<RemotePicturesPageEventHandler> {

  public static Type<RemotePicturesPageEventHandler> TYPE =
      new Type<RemotePicturesPageEventHandler>();
