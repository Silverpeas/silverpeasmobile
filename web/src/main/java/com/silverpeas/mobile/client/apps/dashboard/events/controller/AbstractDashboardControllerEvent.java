...
public abstract class AbstractDashboardControllerEvent extends
    GwtEvent<DashboardControllerEventHandler> {

  public static Type<DashboardControllerEventHandler> TYPE =
      new Type<DashboardControllerEventHandler>();
