...
public abstract class AbstractLocalPicturesPageEvent extends
    GwtEvent<LocalPicturesPageEventHandler> {

  public static Type<LocalPicturesPageEventHandler> TYPE =
      new Type<LocalPicturesPageEventHandler>();
