...
public class FormOnlineField extends Composite {

  private FormFieldDTO data;
  private static FormOnlineFieldUiBinder uiBinder = GWT.create(FormOnlineFieldUiBinder.class);

  @UiField
  HTMLPanel container;
  protected ApplicationMessages msg = null;

  interface FormOnlineFieldUiBinder extends UiBinder<Widget, FormOnlineField> {}

  public FormOnlineField() {
