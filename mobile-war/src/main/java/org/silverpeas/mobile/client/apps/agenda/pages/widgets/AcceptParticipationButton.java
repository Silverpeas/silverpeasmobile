 ...
 * @author svu
 */
public class AcceptParticipationButton extends ActionItem {

  public static final String ID = "acceptParticipation";

  interface AddReminderButtonUiBinder extends UiBinder<HTMLPanel, AcceptParticipationButton> {
  }
  ...
  public AcceptParticipationButton() {
  ...
  @UiHandler("action")
  void acceptParticipation(ClickEvent event) {
  ...
  public void setEvent(final CalendarEventDTO event) {
    this.eventDTO = event;
  }
}
