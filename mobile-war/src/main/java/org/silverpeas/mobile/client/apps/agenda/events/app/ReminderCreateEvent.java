...
public class ReminderCreateEvent extends AbstractAgendaAppEvent {

  private ReminderDTO reminder;
  private CalendarEventDTO event;

  public ReminderCreateEvent(CalendarEventDTO event, ReminderDTO reminder) {
    super();
    this.event = event;
