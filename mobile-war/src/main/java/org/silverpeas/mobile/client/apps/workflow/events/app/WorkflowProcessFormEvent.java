...
public class WorkflowProcessFormEvent extends AbstractWorkflowAppEvent {

  public WorkflowProcessFormEvent() {
    super();
  }
  ...
  public void setData(final List<WorkflowFieldDTO> data) {
    this.data = data;
  }
