 ...
 * @author: svu
 */
public abstract class RestMethodCallbackOnlineBackground<T> implements RestCallback<T> {
  ...
  public void onFailure(final RestMethod method, final Throwable t) {
    if (method.getStatusCode() == 403 || method.getStatusCode() == 401) {
      ...
      if (NetworkHelper.needToGoOffine(t)) {
        ...
        GWT.log(method.getHTTPMethod() + " " + method.getUrl());
  ...
  @Override
  public void onSuccess(final RestMethod method, final T t) {}
