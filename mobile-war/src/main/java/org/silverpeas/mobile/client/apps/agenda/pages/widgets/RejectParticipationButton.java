 ...
 * @author svu
 */
public class RejectParticipationButton extends ActionItem {

  public static final String ID = "rejectParticipation";

  interface AddReminderButtonUiBinder extends UiBinder<HTMLPanel, RejectParticipationButton> {
  }
  ...
  public RejectParticipationButton() {
