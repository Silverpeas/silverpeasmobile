...
import org.silverpeas.mobile.client.apps.formsonline.events.app.FormOnlineAsReceiverLoadEvent;
...
public class FormOnlineAsReceiverItem extends Composite implements ClickHandler {
  ...
  interface FormOnlineItemUiBinder extends UiBinder<Widget, FormOnlineAsReceiverItem> {}

  public FormOnlineAsReceiverItem() {
  ...
  public void setData(FormDTO data) {
    ...
    html += "<span class='number'>" + data.getNbRequests() + "&nbsp;" + msg.requestsNumber() + "</span>";
  ...
  public void onClick(final ClickEvent event) {
    EventBus.getInstance().fireEvent(new FormOnlineAsReceiverLoadEvent(data));
  }
}
