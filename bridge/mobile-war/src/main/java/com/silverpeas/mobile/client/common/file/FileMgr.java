package com.silverpeas.mobile.client.common.file;
	...
	private static native void requestFileSystemNative(int type, FileSystemCallback callback) /*-{
		$wnd
				.requestFileSystem(
						...
						0,
						function(success) {
							callback.@com.silverpeas.mobile.client.common.file.FileMgr.FileSystemCallback::onSuccess(Lcom/silverpeas/mobile/client/common/file/FileMgr$FileSystem;)(success);
						},
						function(error) {
							callback.@com.silverpeas.mobile.client.common.file.FileMgr.FileSystemCallback::onError(Lcom/silverpeas/mobile/client/common/file/FileMgr$FileError;)(error);
						});
	}-*/;
	...
	public static native void testFileExists(String fileName, FileMgrCallback callback) /*-{
		$wnd.navigator.fileMgr
				.testFileExists(
						...
						function(error) {
							callback.@com.silverpeas.mobile.client.common.file.FileMgr.FileMgrCallback::onError(Lcom/silverpeas/mobile/client/common/file/FileMgr$FileError;)(error);
						});
	}-*/;
	...
	public static native void getFreeDiskSpace(FreeDiskSpaceCallback callback) /*-{
		$wnd.navigator.fileMgr
				.getFreeDiskSpace(
						...
						function(error) {
							callback.@com.silverpeas.mobile.client.common.file.FileMgr.FreeDiskSpaceCallback::onError(Lcom/silverpeas/mobile/client/common/file/FileMgr$FileError;)(error);
						});
	}-*/;
		...
		private final native void getDirectoryNative(String path, JavaScriptObject options, EntryCallback callback) /*-{
			this
					.getDirectory(
							...
							options,
							function(success) {
								callback.@com.silverpeas.mobile.client.common.file.FileMgr.EntryCallback::onSuccess(Lcom/silverpeas/mobile/client/common/file/FileMgr$Entry;)(success);
							},
							function(error) {
								callback.@com.silverpeas.mobile.client.common.file.FileMgr.EntryCallback::onError(Lcom/silverpeas/mobile/client/common/file/FileMgr$FileError;)(error);
							});
		}-*/;
	...
	public static class DirectoryReader extends Entry {
		...
		public final native void readEntries(ReaderCallback callback) /*-{
			this
					.readEntries(
							function(success) {
								$entry(@com.silverpeas.mobile.client.common.file.FileMgr.DirectoryReader::processCallback(Lcom/google/gwt/core/client/JsArray;Lcom/silverpeas/mobile/client/common/file/FileMgr$ReaderCallback;)(success, callback));
							},
							function(error) {
								callback.@com.silverpeas.mobile.client.common.file.FileMgr.ReaderCallback::onError(Lcom/silverpeas/mobile/client/common/file/FileMgr$FileError;)(error);
							});
		}-*/;
	...
	public static class FileEntry extends Entry {
		...
		public final native FileWriter createWriter(FileWriterCallback callback) /*-{
			this
					.createWriter(
							function(success) {
								callback.@com.silverpeas.mobile.client.common.file.FileMgr.FileWriterCallback::onSuccess(Lcom/silverpeas/mobile/client/common/file/FileMgr$FileWriter;)(success);
							},
							function(error) {
								callback.@com.silverpeas.mobile.client.common.file.FileMgr.FileWriterCallback::onError(Lcom/silverpeas/mobile/client/common/file/FileMgr$FileError;)(error);
							});
		}-*/;
		...
		public final native File file(FileCallback callback) /*-{
			this
					.file(
							function(success) {
								callback.@com.silverpeas.mobile.client.common.file.FileMgr.FileCallback::onSuccess(Lcom/silverpeas/mobile/client/common/file/FileMgr$File;)(success);
							},
							function(error) {
								callback.@com.silverpeas.mobile.client.common.file.FileMgr.FileCallback::onError(Lcom/silverpeas/mobile/client/common/file/FileMgr$FileError;)(error);
							});
		}-*/;
	...
	public static class Entry extends JavaScriptObject {
		...
		public final native String getMetadata(MetadataCallback callback) /*-{
			this
					.getMetadata(
							function(success) {
								callback.@com.silverpeas.mobile.client.common.file.FileMgr.MetadataCallback::onSuccess(Lcom/silverpeas/mobile/client/common/file/FileMgr$Metadata;)(success);
							},
							function(error) {
								callback.@com.silverpeas.mobile.client.common.file.FileMgr.MetadataCallback::onError(Lcom/silverpeas/mobile/client/common/file/FileMgr$FileError;)(error);
							});
		}-*/;
	...
	public static class FileBase extends JavaScriptObject {
		...
		public final native void onProgress(EventCallback callback) /*-{
			this.onprogress = function(event) {
				callback.@com.silverpeas.mobile.client.common.file.FileMgr.EventCallback::onEvent(Lcom/silverpeas/mobile/client/common/file/FileMgr$Event;)(event);
			};
		}-*/;
		...
		public final native String upload(String filePath, String serverUrl, FileTransferCallback callback, FileTransferOptions options) /*-{
			return this
					.upload(
							...
							serverUrl,
							function(result) {
								callback.@com.silverpeas.mobile.client.common.file.FileMgr.FileTransferCallback::onSuccess(Lcom/silverpeas/mobile/client/common/file/FileMgr$FileTransferResult;)(result);
							},
							function(error) {
								callback.@com.silverpeas.mobile.client.common.file.FileMgr.FileTransferCallback::onError(Lcom/silverpeas/mobile/client/common/file/FileMgr$FileTransferError;)(error);
							}, options);
		}-*/;
